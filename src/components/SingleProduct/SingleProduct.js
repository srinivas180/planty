                    ...
                    <div className="cart-item single-product">
                        ...
                        <div className="cart-item__details single-product__details">
                            ...
                            <div className="cart-item__category">
                                <span className="category__title">Category: </span> {product.categoryName}
                            </div>
                            <div className="single-product__description">
                                Lorem magna euismod magna ipsum et sit dolore ea eleifend voluptua labore kasd lorem enim ipsum ipsum amet.
                                Lorem vero ipsum sea ea duo ea stet justo ut no ut. Sed euismod laoreet consectetuer volutpat amet adipiscing
                            ...
                            <div className="cart-item__buttons">
                                ...
                                >
                                    {
                                        wishlistHasItem(product ?? false) ? "Unwishlist" : "Add to wishlist"
                                    }
                                </button>
                            </div>
                        </div>
